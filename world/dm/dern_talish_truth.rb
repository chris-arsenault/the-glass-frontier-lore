dm :dern_talish_truth do
  name "Dern Talish — DM Truth"
  path "dm/dern-talish-truth.md"
  tags :governance, :resonance
  dm! public_entry: :dern_talish

  prose <<~PROSE
    Public entry: #{ref :dern_talish, "Dern Talish"}
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Read-In"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Arrangement"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "What She Knows"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Language"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Hand"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Collection"
