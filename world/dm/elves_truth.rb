dm :elves_truth do
  name "Elves — DM Truth"
  path "dm/elves-truth.md"
  tags :species, :religion, :"ring-era"
  dm! public_entry: :elves

  prose <<~PROSE
    Public entry: #{ref :elves, "Elves"}
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "Why They Left"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Scrubbing"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "Where They Are Now"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Adversary"
    The force that destroyed the orbital ring. The elves know what it is: the #{ref :the_false_form_truth, "False Form"} — the figure that will not close, given will. It is the same thing the public cosmology of #{ref :the_three_forms, "The Three Forms"} draws as the impossible third panel and dismisses as an abstraction. The elves know it is no abstraction. See #{ref :the_false_form_truth, "The False Form — DM Truth"} for the full account.
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Bloom Zones"
  ...
  PROSE
  prose <<~PROSE, section: :truth, heading: "The Council Contact"
  ...
  PROSE
  prose <<~PROSE, section: :implications, heading: "The Cultural Sacrifice"
  ...
  PROSE
  prose <<~PROSE, section: :usage_notes, heading: "DM Usage Notes"
