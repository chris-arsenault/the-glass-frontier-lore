thread :reconnection do
  ...
  prose <<~PROSE, section: :how_it_works, heading: "Beat Sequence"
    ...
    **Large communities** (Sithari, others) stabilize through institutional strength. #{ref :sithari, "Sithari"} and #{ref nil, "The Continuity", path: "dm/index.md"} flourish precisely because they don't need anyone else. Self-sufficiency becomes identity, not just survival strategy.
