installation :threshold_station do
  ...
  prose <<~PROSE, section: :present_day, heading: "Present Day"
    The station has been at L1 for as long as anyone remembers and shows no sign of moving. The Synod has been in residence for sixty-odd years. The Wardens have held the seals for almost as long. The terminus has carried Span traffic continuously since rediscovery. The envoys cycle through.
