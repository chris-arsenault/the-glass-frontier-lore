species :elves do
  ...
  prose <<~PROSE
    One of the founding species of the Kaleidos system, primary architects of the #{ref :the_glass_frontier, "orbital ring"}, and for centuries the most technically sophisticated civilization in the system. Then, during the #{ref nil, "Signal Famine", path: "player/history/index.md"}, they disappeared. Where they went, why they left, and whether "left" is even the right word are questions that 130 years of scholarship haven't answered.
  PROSE
