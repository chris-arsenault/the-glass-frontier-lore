installation :hab_meridian do
  ...
  prose <<~PROSE, section: :present_day, heading: "Present Day"
    Hab Meridian in 2435 CE is one of the most stable institutions in the system. The visitor traffic has been steady for decades. The Period Arc's preservation work is in good order. The hab council is competent. The relationships with Glasswake, Sithari, and the Accord are durable. The hab is not growing and not shrinking. It is doing what it has done for one hundred and thirty years.
