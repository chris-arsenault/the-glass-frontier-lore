encyclopedia :attunement do
  ...
  prose <<~PROSE, section: :applications, heading: "Daily Use"
    Most attuned people are not full-time #{encyclopedia_ref :tuners, "Tuners"}. They are mechanics who feel drift before a gauge moves, pilots who notice a change in a kite's thrust through the deck, healers who can separate lattice pain from an ordinary fracture, and householders who know which room will become uncomfortable when the local field runs thin. The ability becomes valuable wherever a device and its surroundings affect one another.
