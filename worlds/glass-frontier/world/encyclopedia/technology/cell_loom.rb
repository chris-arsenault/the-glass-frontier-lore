encyclopedia :cell_loom do
  ...
  summary "A cell loom is a room-sized frame that weaves live stillwater culture into damping sheet inside a purpose-built quiet chamber. Each run is rated and traced to its loom, supplying stillhull plate, still-diver suits, and instrument shielding across Kaleidos."
  ...
  variation "Weaving lines hold the pattern craft hands-on across generations, and a loom changing families is registry news because buyers track who set the patterns behind each run."
end
