encyclopedia :channel_barge do
  ...
  prose <<~PROSE, section: :mechanics, heading: "Hull, Drive, and Pole"
    ...
    #{encyclopedia_ref :pole_thief, "Pole-thieves"} make that reading less certain. The animals strike a sounding shoe from beneath the bank and can make firm ground feel suddenly alive. Experienced pilots pause after the first blow, look for the spreading rings, and use a second pole before changing course.
  PROSE
