encyclopedia :heavy_hauler do
  ...
  prose <<~PROSE
    The industrial cargo vessel class that moves bulk goods along #{ref :keel, "the Keel"} and the outer-system trade routes. Heavy haulers are the largest civilian #{encyclopedia_ref :kite_sail, "kite"}-driven vessels in regular commercial service: slow by deliberate choice, sturdy by necessity, and load-bearing for nearly the entire system's bulk economy. #{ref :vantara, "Vantara"} operates the largest fleet; independent operators run the rest. A heavy hauler is the unglamorous backbone of orbital civilization.
  ...
  cue "Getting anywhere along #{ref :keel, "the Keel"} usually means riding a hauler whose eight to twelve crew have sailed together for fifteen or twenty years, raise children aboard, and fold passengers into a watch rotation that was settled long before the party booked passage."
  ...
  pressure "A coupled-freight load rides in bulkheaded bays with its monitoring instruments cut off from the ship's cadence, so no one aboard can tell the party what is in those bays or whether anything has changed inside them since loading."
