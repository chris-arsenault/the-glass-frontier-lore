encyclopedia :shade_burial do
  ...
  pressure "The calendar rules the rite, so a death in a thin-passing season forces the choosing — the swift lesser shade soon, or the worthy deep shade a long wait away — and the gentle family argument over the shade-table is grief doing arithmetic."
  variation "Valley families hold to fragment shades their line has used for generations; the diaspora districts lower under whatever passing serves, and mark the shade-table with an asterisk the valleys pretend not to notice."
  variation "The honored dead wait for the deep seasonal shades, and a burial under the great slow crossing of a named fragment draws shade families from three valleys to stand at the edges of a stranger's grief."
end
