encyclopedia :hab_worlder do
  ...
  prose <<~PROSE, section: :values, heading: "Hab Differences"
    ...
    Names carry the same local range. Compact forms travel well through crowded channels, while deck names, household tools, earned work, and surviving lock numbers supply different second elements from hab to hab. #{encyclopedia_ref :naming_conventions, "Names in Kaleidos"} records the broader pattern; #{encyclopedia_ref :kesh_challenge_names, "Kesh Challenge Names"} and #{encyclopedia_ref :span_names, "Span Names"} show two practices that grew from particular hab work.
  PROSE
