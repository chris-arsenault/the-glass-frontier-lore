encyclopedia :cordon_children do
  name "Cordoners"
  ...
  prose <<~PROSE
    Cordon services teach their warning palette through nursery songs. Once a child can walk, the household stitches the current safe routes into sleeves and hems and resews them whenever the boundary shifts. Children repeat the day's colors at the doorway, follow closure bells, and hear #{encyclopedia_ref :bloom_sense, "sensitives"} grade an approaching emission. During #{encyclopedia_ref :still_mornings, "still mornings"}, families walk the safe lines and report damaged marks or changed ground.
