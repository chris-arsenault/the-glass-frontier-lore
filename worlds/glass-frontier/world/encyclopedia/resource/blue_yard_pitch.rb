encyclopedia :blue_yard_pitch do
  ...
  availability "Boiled at yard shops from mineral tar and glass fines; the Dry Net, Three Arms Yard, Blue Step Works, and Lot Forty keep the best-known kettles, each with a distinct set and peel"
  ...
  prose <<~PROSE, section: :trade, heading: "Kettles and Recipes"
    ...
    Pitch releases whenever the vibration stops, including during an unplanned stall. Every pitch-sealed assembly therefore carries a stall standing order. The #{encyclopedia_ref :workshop_authority, "stop-authority"} custom prices a full peel and reseal into any halt call, and the crew follows the call anyway.
  PROSE
