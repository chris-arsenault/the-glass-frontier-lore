encyclopedia :loadfront do
  ...
  prose <<~PROSE
    ...
    The country reads the approach through several signs. Instruments lift in sequence down the line; #{encyclopedia_ref :gleeds, "gleeds"} run green early along the track; #{encyclopedia_ref :resonance_lichen, "lichen"} darkens out of season; and herds walk off the sheets after sensing the load through their feet. Many glass-country residents report aching teeth ahead of a front. Medical surveys confirm the timing without establishing its mechanism. Front discipline is the region's shared work rule: lifts land before the window, cuts wait, crossings clear the sheets, and singers re-sing anything the front touched before it flies again.
  PROSE
