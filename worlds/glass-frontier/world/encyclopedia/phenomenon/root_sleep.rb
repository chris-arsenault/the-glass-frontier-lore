encyclopedia :root_sleep do
  ...
  prose <<~PROSE
    Sleep stills a garden deck in a day, sometimes in mid-season. Leaves furl, growth stops across every bed, and #{encyclopedia_ref :root_deck_symbiotes, "the Graft's murmur"} disappears. The uniform timing distinguishes it from ordinary blight. The plants and symbiotes remain barely alive and consume little. Recorded attempts with local water, added heat, and fresh grafts do not wake them. Living water carried from another habitat succeeds when poured at the sleeping deck's oldest graft; over the following days, beds resume growth outward in the order they were grafted.
