encyclopedia :keener do
  ...
  descriptive_identity(
    ...
    manner: "Composed, formal, and precise; keeners interview the family before the " \
  ...
  pressure "Household interviews, hand-copied mode books, and letters from earlier clients establish a keener's standing. A family hears its own names and account in the descent and may withhold a standing letter when the rendering is inaccurate."
  ...
  prose <<~PROSE
    ...
    Undyed gray against every local funeral color marks the keener as hired voice rather than kin. The client household's cord, worn at the wrist for the day and returned with the fee's receipt, marks whose grief is being rendered. Letters of standing from households served certify a keener between towns. The family supplies names and memories at the interview; the keener repeats the account back before setting it in the mode. The profession states the arrangement in its oldest saying: the elves left the forms and left, so someone has to be home to sing them.
  PROSE
end
