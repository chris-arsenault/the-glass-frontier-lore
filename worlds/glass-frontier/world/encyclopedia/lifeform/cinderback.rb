encyclopedia :cinderback do
  ...
  cue "Cinderbacks collect behind a parked vehicle for its shade and stay put once the drive begins warming. Ashvane drivers walk the whole chassis before departure; skipping the walk starts the run with animals under the machinery."
  ...
  pressure "A frightened cinderback digs toward cooler ground instead of running, even when the cool ground lies under a house floor. Its claws go through ceramic joints, old sealant, and cooling cloth, so a herd scattered by noise ends as a floor repair."
