encyclopedia :sorel do
  ...
  affordance "Watching where the herd feeds and where it will not gives a party the shell survey for nothing: cropped soft mineral marks new growth, untouched ridges are carrying load, and a herd that settles and stays has found warm water behind the wall."
