encyclopedia :glass_burrower do
  name "Glass Burrower"
  kind :lifeform
  subkind :creature
  status :complete
  ...
  variation "Sheet settlements name resident burrowers and track their hums across generations; the Shear's fused masses carry bores wider than any surface survey has recorded."
