encyclopedia :vault_moth do
  ...
  summary "Vault moths are pale, silent moths bred by the elves to graze mold from stored records. Great archives keep working colonies and read clustering, feeding, and the dawn return count as signs of stack conditions."
  ...
  descriptive_identity(
    ...
    threat: "The breeding keeps the moths on the bloom and off the ink. Starving colonies are the recorded " \
  ...
  prose <<~PROSE
    The #{encyclopedia_ref :elves, "elves"} bred vault moths to clear mold from archive stores. The palm-width moths are dust-pale and silent in flight, with brush-tipped legs and a diet of paper molds, soured binding pastes, and fungal blooms from damp storage. A grazing moth crosses an affected page and leaves the ink untouched in a clean stripe through the bloom. Ring registries list colony houses and provisioning schedules among vault equipment, and present archives retain that pattern.

    Colonies patrol their stacks in the dark hours and favor the same rounds each night. Clean stripes mark where bloom was found, and moths clustered along one shelf run indicate damp in the wall behind it. Stack crews inspect the wall on that sign. At the dawn bell, archivists count the returning moths; a low count sends staff through the stacks to find the remaining grazers.
  PROSE
