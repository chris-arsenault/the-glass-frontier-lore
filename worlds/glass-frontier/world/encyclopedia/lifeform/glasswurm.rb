encyclopedia :glasswurm do
  ...
  affordance "Sustained sounding, a repeated hammer, or a scan run twice near a wurm-held fragment is a structural note the animal follows. It comes back along a tunnel it already cut, so it arrives through ground the crew has walked and cleared."
  ...
  variation "Old wurms carry enough glass to answer a sounder from across a fragment."
