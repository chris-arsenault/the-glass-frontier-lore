encyclopedia :cold_route_spores do
  ...
  prose <<~PROSE, section: :operations, heading: "Fouling and the Stranded Camp"
    ...
    Navigation lamps are the usual sustained tone, but heaters and instruments can also wake the spores. A crew running equipment through a cold night may wake inside a young flowering. Patrols log every fan ring found off the marked road as evidence of an earlier camp or unlisted route.
  PROSE
  ...
  variation "Some outer crews plant a lamp over rich spore ice and farm the fans; route records distinguish those regular harvest rings from colonies around navigation lamps."
end
