creature :cthonic_beasts do
  ...
  prose <<~PROSE
    The collective name for the wide and unrelated family of creatures that live in #{ref :the_shear, "the Shear"}. Cthonic beasts have no single body plan, no single ancestor, and no clear taxonomic relationship to any other life in the system. They are grouped by where they live, not by what they are.

    Bestiaries divide them into convenient working categories — drift-eels and shellbacks and the rest — but the categories are habits and habitats, not lineages. What unifies the beasts is the place they inhabit, the impossible features they share, and the open question of where they came from.
  PROSE
  prose <<~PROSE, section: :atmosphere, heading: "What They Have In Common"
    A Cthonic beast can be three meters long or three hundred. It can be silicate or fleshy or filamentary, single-bodied or distributed, ambulatory or sessile, predator or grazer or something stranger. None of this constrains the category. The unifying features are narrower.

    **Too many eyes.** Every documented Cthonic beast has more eyes than its body plan should require. A worm-like beast with eyes along its entire ventral surface. A drifting jellyfish-thing with eyes inside its bell, looking outward through translucent tissue. A massive ooze with eyes that surface and submerge through its body at intervals. The eyes are not always functional in any sense observers can confirm; some of them clearly are, and track movement; some of them stare without focus; some of them appear to look at things that are not there.

    **Too many mouths.** Every documented Cthonic beast has more mouths than its feeding behavior should require. Mouths along flanks, along tentacles, in the interior of larger mouths. Some mouths feed. Some vocalize. Some do neither, in any way that observers have been able to determine. Most of the larger beasts have multiple feeding apertures that operate independently — a drift-eel can be eating from three places at once, taking different things into different mouths and processing them separately.

    **A wrongness that survives the data.** A Tuner standing in resonance contact with a Cthonic beast does not feel an animal. They feel something that is not quite where it is, or not quite what it is, or both. The wrongness is hard to articulate and impossible to instrument. Researchers who work with the beasts learn to recognize it; researchers who haven't, dismiss it. The Tuners who work with the #{ref :displacement_council, "Displacement Council"}'s containment teams say the wrongness is the same wrongness, in lower amplitude, that they feel near #{ref :bloom_zones, "Bloom Zones"}. The Conclave declines to confirm the comparison and declines to deny it.

    The combination of features — the eyes, the mouths, the wrongness — is consistent across the entire Cthonic taxonomy. It is the only thing that is.
  PROSE
  prose <<~PROSE, section: :description, heading: "Known Types"
    ...
    **Drift-eels.** Long filamentary predators, kilometers in length at the largest, that drift through the Shear hunting electrical and resonance activity. They strike at active ships. The damage they do depends on size: a small eel will spike a hull and steal current; a large one will wrap a skiff and crush it. Drift-eels are common, manageable with proper dampening, and the textbook nuisance-tier threat. Most Shear crews have a drift-eel story.

    **Shellbacks.** Slow ringglass-shelled grazers that attach to debris masses and feed on the resonance-saturated material around them. Mostly harmless to crews unless physically disturbed, in which case they retract into their shells and the shells become difficult to move and dangerous to be near. Their shed shell-fragments are a minor salvage product. They are the closest thing to wildlife the Shear produces in the sense surface people understand wildlife.

    **Glasswurms.** Large segmented borers that tunnel through soft debris masses and large ringglass aggregates. They produce useful structural shapes as a side effect of their feeding, which has made them a research subject for materials scientists; they also produce sudden structural failures in debris masses crews were depending on, which has made them a research subject for safety boards.
    ...
    **Shear-jellies.** Drifting bell-bodied beasts with internal eyes and stinging filaments. Most are small and avoidable; some are large enough to envelop a skiff; one documented specimen in the Deep Shear in 2378 was reported at over a kilometer across, which the Conclave will neither confirm nor deny.

    **Dragons.** The catch-all term for the largest single-body predators in the Shear, used by crews and resisted by academics. Massive, winged in the sense that they have membranous appendages, fanged in the sense that they have feeding apparatus that can shear a hull. They are rare. Each documented individual is famous. A small handful of long-lived dragons have been tracked by the Compact across decades and given names: **Ironwhistle**, **Long Mother**, **Pale Star**. Some crews refuse to speak the names aboard ship.

    **Hush-stalkers.** Deep Shear ambush predators that feed on resonance signatures rather than on matter. A Tuner using their sense in the Deep is a beacon to them, which makes Tuner-led Deep work both essential and dangerous. Hush-stalkers are responsible for a significant fraction of Deep-runner casualties. Specialized dampening kits exist to mask Tuner signatures; the kits work most of the time.
  ...
  prose <<~PROSE, section: :operations, heading: "Hunting and Bounty"
    Most crews who deal with Cthonic beasts deal with them by avoiding them. Standard Shear practice is detect, divert, and stay quiet. A working dampening rig and a careful Tuner can keep a ship from being interesting to most of the beasts most of the time.

    When a beast cannot be avoided, the dominant approach is bounty work. The #{ref :shear_compact, "Shear Compact"}, Coremark, individual habs, and occasionally the Accord post bounties on specific dangerous individuals — beasts that have taken ships, beasts threatening traffic routes, named beasts whose behavior has become a problem. The bounties draw a small population of professional hunters who specialize in this work. The hunters have reputations and rivalries. The kills are stories.
  ...
  prose <<~PROSE, section: :present_day, heading: "Present Day"
    The Cthonic beasts are part of the working environment of the Shear. Crews work around them. Hunters work against them. Researchers work on them. The bestiary expands. The bounties get posted and answered. The largest dragons drift across decades of records. The choir-things, when they appear, are recorded by anyone who survives the encounter and the recordings are paid for.
