...
relate :rel_named_drift_eels_inhabit_shear, :inhabits, :named_drift_eels, :the_shear do
  prose "Ratter route records track named drift-eels through the working Shear."
end
relate :rel_named_drift_eels_inhabit_deep_shear, :inhabits, :named_drift_eels, :deep_shear do
