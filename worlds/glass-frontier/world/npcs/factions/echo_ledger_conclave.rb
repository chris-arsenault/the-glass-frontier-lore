faction :echo_ledger_conclave do
  ...
  prose <<~PROSE, section: :operations, heading: "Field Cells"
    ...
    The cordon-support crews are also, structurally, the inheritance of the #{ref :bloom_coalition, "Bloom Coalition"}'s cross-faction working culture. The Coalition put Conclave personnel inside Council operations during the active emergency, and the practice continued after the Coalition's dissolution. The relationship between the Conclave and the Council is, as a result, deeper than the relationship between the Conclave and most other factions — the two institutions have been doing dangerous work together for more than half a century.
  PROSE
