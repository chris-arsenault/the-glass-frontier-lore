faction :bloom_coalition do
  ...
  prose <<~PROSE, section: :present_day, heading: "Legacy"
    ...
    **The cultural memory** is broader and harder to measure. The Coalition's eighteen years of forced cooperation produced a generation of operators who had worked across faction lines on a mission that mattered. Many of them are still alive in #{year :now} CE — old now, retired or near it, scattered across the system. Where they have continued to be active they have been disproportionately involved in the kind of cross-faction work the Accord makes possible. The Coalition is over. The people are not.
