faction :lattice_proxy_synod do
  ...
  prose <<~PROSE, section: :present_day, heading: "Present Day"
    ...
    They are aware that this arrangement is precarious. They are also aware that it has worked for #{elapsed :lattice_proxy_synod, approx: true}, and that the system's alternatives are worse. The Synod's institutional posture is quiet confidence — not arrogance, but the steady assurance of people who have been right enough, often enough, to earn the benefit of the doubt.
