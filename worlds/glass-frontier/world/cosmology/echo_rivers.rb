phenomenon :echo_rivers do
  ...
  prose <<~PROSE
    Beneath the surface of Kaleidos, water moves through rock that's been saturated with crystal dust from nearly three centuries of #{ref :the_glassfall, "Glassfall"} debris. As it flows through these mineral-laced channels, it picks up #{ref :resonance, "resonance"} — specifically, the signal-band frequencies that once carried data through the orbital rings.
  ...
  prose <<~PROSE, section: :how_it_works, heading: "What You Hear"
    ...
    - Personal messages. Someone calling home. A child's voice. Laughter from a party that happened three centuries ago.
