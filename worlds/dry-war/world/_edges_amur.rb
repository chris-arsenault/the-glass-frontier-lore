...
relate :rel_amur_post_carries_mycelium, :carries, :tangwang_post, :continental_mycelium, since: 2088
...
relate :rel_amur_tsoi_severed_from_mycelium, :severed_from, :nadya_tsoi, :continental_mycelium
...
relate :rel_amur_sanchakou_depends_mycelium, :depends_on, :sanchakou, :continental_mycelium
