installation :mulberry_court_clinic do
  ...
  prose <<~PROSE, section: :structure, heading: "The Western Rooms"
    Each room is a shell of fired tile inside the connected building, reached through two doors with a dry inspection space between them. It has no continuous water or waste pipe. Drinking and wash water arrive in glass carafes; waste leaves in lidded ceramic vessels through the lower half of a double hatch. Air crosses salt beds and replaceable cotton filters that are baked after each leave.
