incident :the_sixth_bell_finding do
  name "The Sixth-Bell Finding"
  tags :legibility, :religion, :governance
  prominence :forgotten

  prose <<~PROSE
    In 2087 #{ref :caretaker, "Caretaker"} re-cut the insurance on the Detroit ambience programme after a bearing failure in the north tower of #{ref :ste_anne_belfry, "Ste. Anne"}. A re-cut requires each insured item to be the item described, and the asset schedule described eight bells cast in 2074 for the programme. Two had been recast in 2081 after cracks and carried clean paperwork. The sixth had no founder's mark under the crown.
  ...
  prose <<~PROSE, section: :aftermath, heading: "The Sixth Rope"
    The sixth is the heaviest-going of the eight and sits slightly off the ring in strike note. Ouellette's two oldest ringers do not take it, so a morning that assembles seven ringers is short the sixth rope more often than any other, and a session short the sixth is a session not rung.

    Marchand's return for #{year :now} files the nine cancellations under programme risk. The asset schedule's age field for the sixth bell reads unknown, the only such entry in the district's record.
  PROSE
end
