faction :the_great_root do
  ...
  prose <<~PROSE, section: :origin, heading: "How It Arrived"
    Through #{ref :living_textiles, "clothing"}, and enthusiastically. The first garments cooled their wearers through the worst summers on record, filtered air that was killing people, and caught cancers early enough to matter. Municipal governments subsidized them. Hospitals integrated them. Logistics adopted them because fungal sensor networks outperformed electronics in wet rural conditions.

    By the time anyone established that information was passing *between* wearers, removal would have meant dismantling the health system, the harvest and the supply chain in the same quarter. The decisive era of the age, #{ref :the_quiet_conquest, "the Quiet Conquest"}, contains no battles at all.
  PROSE

  prose <<~PROSE, section: :structure, heading: "Not One Mind"
    Whether the Great Root is a single mind is an open question, and it is argued in the ministries as often as in the desert.
