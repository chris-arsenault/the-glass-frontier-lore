faction :the_forty_seven do
  ...
  prose <<~PROSE
    The households that declined new addresses during #{ref :the_cairo_retreat, "the Cairo Retreat"} and remained in #{ref :cairo, "Cairo"}'s lowest ward after municipal services moved uphill. The name records the number of households on #{ref :inez_bell, "Inez Bell"}'s old roll when the stay closed, not a fixed membership.
