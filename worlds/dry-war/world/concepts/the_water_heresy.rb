concept :the_water_heresy do
  ...
  prose <<~PROSE, section: :reference, heading: "The Figure And Where It Binds"
    The 3.72 litres is not a ration in the sense of a quantity withheld. It is a delivery guarantee, and its authority is that every coalition inherited the same foundational reasoning independently.
