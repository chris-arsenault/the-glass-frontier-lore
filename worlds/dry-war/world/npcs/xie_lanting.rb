npc :xie_lanting do
  ...
  prose <<~PROSE, section: :people, heading: "What She Cuts In March"
    Every March she cuts scionwood from any orchard standing inside an open file — one-year wood, dormant, wrapped in damp moss, grafted onto rootstock in the post's nursery bed in April. Most files are refused and most of the stock is burned in the autumn. She is the only person on the reach who can carry a variety past a ring.

    The cabinet files its objection on the day of every cut: tissue crossing outward from a compartment under an open file is an input it cannot model. #{ref :nadya_tsoi, "Nadya Tsoi"} has allowed the cutting in each year she has held the marking office, and Xie mixes the lime-and-oil paste for rings she has argued against.
  PROSE
