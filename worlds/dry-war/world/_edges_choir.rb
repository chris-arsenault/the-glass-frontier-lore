...
relate :rel_rc_line_practiced_by_choir, :practiced_by, :the_held_line, :the_choir, since: 2071
...
relate :rel_rc_line_evades_predictive, :evades, :the_held_line, :predictive_governance, since: 2071
relate :rel_rc_line_depends_call, :depends_on, :the_held_line, :the_ring_call
relate :rel_rc_line_evades_caretaker, :evades, :the_held_line, :caretaker, since: 2071
relate :rel_rc_line_mentions_ghost, :mentions, :the_held_line, :ghost_pharmacology

# ---- the call itself ----
relate :rel_rc_call_practiced_by_choir, :practiced_by, :the_ring_call, :the_choir, since: 2071
...
relate :rel_rc_call_evades_caretaker, :evades, :the_ring_call, :caretaker, since: 2071
relate :rel_rc_call_evades_predictive, :evades, :the_ring_call, :predictive_governance, since: 2071
...
relate :rel_rc_choir_operates_belfry, :operates_in, :the_choir, :ste_anne_belfry, since: 2071
relate :rel_rc_odile_operates_belfry, :operates_in, :odile_marchand, :ste_anne_belfry, since: 2085
relate :rel_rc_cecile_at_belfry, :located_in, :cecile_ouellette, :ste_anne_belfry, since: 2071
...
relate :rel_rc_line_practiced_by_cecile, :practiced_by, :the_held_line, :cecile_ouellette, since: 2071 do
...
relate :rel_rc_cecile_in_solo, :participated_in, :cecile_ouellette, :the_gratiot_solo do
  prose "She rang the touch it came out of and withdrew the method afterwards."
end
