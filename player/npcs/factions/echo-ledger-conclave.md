---
title: Echo Ledger Conclave
type: faction
tags: [archives, resonance, signal-freq, governance]
prominence: recognized
---

# Echo Ledger Conclave

Archivists. Gatekeepers. The people who catalogue what the ground remembers and decide who gets to hear it.

The Conclave exists because the [Echo Rivers](../../cosmology/echo-rivers.md) exist, and because someone had to take responsibility for what surfaces in them. They are headquartered in the [Sable Crescent](../../locations/regions/sable-crescent.md), where the rivers are densest, and they have made themselves indispensable to anyone who needs the past authenticated, interpreted, or — occasionally — suppressed.

## Origin <!-- Origin -->

The Conclave formed during the Rekindling, roughly 2310 CE, when reconnecting settlements began comparing notes about the [Echo Rivers](../../cosmology/echo-rivers.md) and realized the same phenomenon was surfacing across the planet. Early archivists were just listeners — people who sat near surfacing points and wrote down what they heard. The Conclave organized them, standardized their methods, and — critically — claimed custodianship over the material.
...
## Field Cells <!-- Operations -->

The Conclave's operational personnel deploy as **field cells** — small teams seconded from [Thornvault](../../locations/settlements/thornvault.md) or from a satellite office for the duration of a specific assignment. The cell is the working unit; the chapter or office is the administrative home. Three cell patterns do most of the Conclave's field work.

### Retrieval Cells <!-- Operations -->

Retrieval cells go out to acquire artifacts and recordings before someone else does or before the material degrades past recovery. A typical retrieval cell is four to six archivists with a [Clarisant](clarisant.md)-credentialed [Tuner](../../concepts/tuners.md) on contract, traveling by chartered transport with the equipment to assess, package, and extract resonance-sensitive material in the field.

The work is varied. A retrieval cell may be excavating a pre-Glassfall installation that has been newly uncovered by surface erosion. They may be negotiating with a salvage flotilla that has pulled something interesting from the [Deep Shear](../../locations/landmarks/deep-shear.md). They may be racing a [Coremark](coremark.md) convoy unit to a known artifact site whose location has just leaked. They may be quietly buying a recording from a private holder who has decided to sell.

Retrieval cells carry funds. They are authorized to negotiate, to pay, and, within limits, to commit the Conclave to long-term institutional relationships with the parties they deal with. Senior retrieval cell leads are some of the most experienced field operators in the Conclave and have the kind of operational latitude that the institution otherwise reserves for its own internal politics. The cells are the most visibly active arm of the Conclave outside Thornvault and the [Sable Crescent](../../locations/regions/sable-crescent.md). When an outside party encounters the Conclave in the field, it is almost always a retrieval cell.
...
Cordon-support crews are the Conclave's contribution to the ongoing [Bloom Zone](../../locations/landmarks/bloom-zones.md) containment work. They embed with [Displacement Council](displacement-council.md) cordons, document the affected zones from inside the containment perimeter, and provide the Council with historical resonance analysis on the affected habs' pre-Bloom condition.
...
The cordon-support crews are also, structurally, the inheritance of the [Bloom Coalition](bloom-coalition.md)'s cross-faction working culture. The Coalition put Conclave personnel inside Council operations during the active emergency, and the practice continued after the Coalition's dissolution. The relationship between the Conclave and the Council is, as a result, deeper than the relationship between the Conclave and most other factions — the two institutions have been doing dangerous work together for sixty years.
