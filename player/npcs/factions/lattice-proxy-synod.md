...
**Navigation and telemetry.** The AI custodians still track orbital mechanics — debris fields, hab trajectories, the [Shear](../../locations/regions/the-shear.md)'s shifting geography. This data is genuinely valuable. The Synod packages it and distributes it to settlements, habs, and the [future:Verge Compact] for salvage route planning. It's the Synod's most reliable revenue stream and the service that makes everyone tolerate their stranger qualities.

**Governance consultation.** The custodians were designed for regulatory oversight. When the Synod queries them on governance questions — dispute resolution frameworks, resource allocation models, jurisdictional boundaries — the responses are surprisingly coherent. The [future:Tempered Accord]'s governance structure was substantially derived from Synod-mediated AI outputs, which the Synod presented to the Accord negotiations with enough confidence to be persuasive and enough humility to be trusted. Whether the Synod fully understood what they were presenting is a question that nobody asks in polite company.
...
The [future:Tempered Accord] relies on them. The [future:Continuity] respects them at arm's length. The [Echo Ledger Conclave](echo-ledger-conclave.md) finds them professionally interesting and personally unnerving. Everyone else just uses the navigation data and tries not to think too hard about where it comes from.
