...
**Navigation and telemetry.** The AI custodians still track orbital mechanics — debris fields, hab trajectories, the [Shear](../../locations/regions/the-shear.md)'s shifting geography. This data is genuinely valuable. The Synod packages it and distributes it to settlements, habs, and the [Shear Compact](shear-compact.md) for salvage route planning. It's the Synod's most reliable revenue stream and the service that makes everyone tolerate their stranger qualities.
...
The [Tempered Accord](tempered-accord.md) relies on them. The [future:Continuity] respects them at arm's length. The [Echo Ledger Conclave](echo-ledger-conclave.md) finds them professionally interesting and personally unnerving. Everyone else just uses the navigation data and tries not to think too hard about where it comes from.
