...
A neutral containment order born from the [Displacement](../../history/events/displacement.md) refugee crisis. The Council maintains [Bloom Zone](../../locations/landmarks/bloom-zones.md) containment cordons, provides humanitarian support to displaced communities, and serves as a trusted mediator precisely because they refused to take sides during the Bitter Reach.
