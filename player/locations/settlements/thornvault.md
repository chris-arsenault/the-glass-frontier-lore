...
The headquarters of the [Echo Ledger Conclave](../../npcs/factions/echo-ledger-conclave.md). A literal bridge-castle: a single immense stone span across the deepest canyon in the [Sable Crescent](../regions/sable-crescent.md), with the Conclave's halls, archives, and residences built into and across the span itself. The [Echo River](../../cosmology/echo-rivers.md) runs at the canyon's base. The Vault listens down into the water.

Thornvault is the Conclave. The Conclave's satellite offices in [Sithari](sithari.md) and elsewhere are postings; Thornvault is the institutional center, the deep archive, and the place every senior archivist eventually spends years living in. The structure is older than the Conclave by a margin nobody has measured.
...
There is no third approach. The canyon walls are not climbable in any practical sense at the Vault's location, and the airspace above the canyon has [resonance](../../cosmology/resonance.md) properties that interfere with [kite](../../artifacts/common/kite-sail.md) operation in ways pilots find sufficiently uncomfortable to avoid. The Conclave's predecessors chose the site for these features and the Conclave maintains the choice.
