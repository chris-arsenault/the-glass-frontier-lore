...
The physical world, its energy systems, and the celestial structures that define the Kaleidos system.

| Entry | Path | Status | Prominence | Tags | Notes |
|-------|------|--------|------------|------|-------|
| The Glass Frontier | [the-glass-frontier.md](the-glass-frontier.md) | complete | mythic | orbital | The shattered ring and its surviving habs |
