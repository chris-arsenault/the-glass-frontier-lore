...
A forced-entry incident during the Contested Reach in which a well-intentioned faction broke into a [shuttered hab](../../concepts/shuttered-habs.md) and discovered that good intentions don't survive contact with a community that considers you a demon. The contact team was slaughtered. One survivor returned. The incident ended the debate over whether shuttered habs should be opened by force.
...
One team member survived. The details of their escape are not widely publicized, but the survivor's account — the first outside description of a fully reverted hab community — became the foundational document for the Accord's sovereignty provisions.
