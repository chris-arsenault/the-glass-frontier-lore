...
A forced-entry incident during the Contested Reach. A faction broke into a [shuttered hab](../../concepts/shuttered-habs.md) expecting a rescue mission and encountered a community that had been sealed for generations. The contact team was slaughtered. One survivor returned.
...
The political impact was immediate and lasting. Forced entry went from "controversial but sometimes necessary" to "unconscionable." When the [Tempered Accord](../../npcs/factions/tempered-accord.md) was drafted years later, the sovereignty provisions — habs can legally refuse contact, and no faction may force entry — existed because of what happened at Coriolis.
